...
| `description`             | String to overwrite the project description with a custom one                                                         | Serverless service description                                             |                                                          |
| `version`                 | String to overwrite the project version with a custom one                                                             | Serverless service version                                                 |                                                          |
